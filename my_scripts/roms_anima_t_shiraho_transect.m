...
% % -------------- No Seagrass 2009/01/01 ------------------------------
grd='/Users/yuta/COAWST/COAWST_DATA/Yaeyama/Shiraho_reef2/Grid/shiraho_roms_grd_HYCOM_v19.0.nc'; 
his_his='/Users/yuta/mount/takagi/COAWST_OUTPUT/Yaeyama/Shiraho_reef2/roms/Shiraho_no_seagrass_his_20090101.nc';
his_qck='/Users/yuta/mount/takagi/COAWST_OUTPUT/Yaeyama/Shiraho_reef2/roms/Shiraho_no_seagrass_qck_20090101.nc';
his_dia='/Users/yuta/mount/takagi/COAWST_OUTPUT/Yaeyama/Shiraho_reef2/roms/Shiraho_no_seagrass_dia_20090101.nc';
...
id = 1; his=his_his; Cbounds=[10 35];     color=colmap6;    % Temperature
% id = 2; his=his_his; Cbounds=[0 38];     color=colmap6;    % Salinity
% id = 3; his=his_his; Cbounds=[1500 3500]; color=colmap6;    % DIC
% id = 4; his=his_his; Cbounds=[2000 3600]; color=colmap6;    % TA    Cbounds=[2230 2360]
% id = 5; his=his_his; Cbounds=[150 350];    color=colmap6;    % DO
% id = 8; his=his_dia; Cbounds=[7.9 8.6];     color=colmap6;    % pH
    % id = 23; % Phytoplankton1
    % id = 24; % Phytoplankton2
    % id = 25; % Phytoplankton
% id = 26; his=his_his; Cbounds=[0 200]; color=colmap7;    % NO3
% id = 27; his=his_his; Cbounds=[0 200]; color=colmap7;    % NO3+NH4
% id = 28; his=his_his; Cbounds=[0 35]; color=colmap7;    % NH4
% id = 29; his=his_his; Cbounds=[0 2.5];  color=colmap7;    % PO4
    % id = 35; % DOC
...
% id = 54; his=his_qck; Cbounds=[0 350]; color=colmap7; fix_bottom=true;    % Sediment DO
% id = 55; his=his_qck; Cbounds=[1500 5000]; color=colmap6; fix_bottom=true;    % Sediment DIC
...
% id = 91; his=his_qck; Cbounds=[7.48 7.53]; color=colmap6; fix_bottom=true;    % Sediment sum of OC
% id = 92; his=his_qck; Cbounds=[1.11 1.16]; color=colmap6; fix_bottom=true;    % Sediment sum of ON
% id = 93; his=his_qck; Cbounds=[0.07 0.0716]; color=colmap6; fix_bottom=true;    % Sediment sum of OP
% id = 401; his=his_dia; Cbounds=[0 100];  color=colmap7;    % sum of DOC
% id = 402; his=his_dia; Cbounds=[0 15];  color=colmap7;    % sum of DON
% id = 403; his=his_dia; Cbounds=[0 1];  color=colmap7;    % sum of DOP
% id = 404; his=his_dia; Cbounds=[0 10];  color=colmap7;    % sum of POC
% id = 405; his=his_dia; Cbounds=[0 1.5];  color=colmap7;    % sum of PON
% id = 406; his=his_dia; Cbounds=[0 0.1];  color=colmap7;    % sum of POP
...
% id = 410; his=his_dia; Cbounds=[0 50];  color=colmap7;    % sum of phytoplankton
% id = 411; his=his_dia; Cbounds=[0 1];  color=colmap7;    % sum of zooplankton
% id = 412; his=his_dia; Cbounds=[0 10];  color=colmap7;    % sum of PIC
...
elseif id == 412 % sum of PIC
    [h_surf,h_surf2,h_contour,h_annot,axes1,axes2]=createfiguretransect(x_rho,x_rho2,y_rho,z_rho,tmp,tmp2,tmp_alpha,tmp_alpha2,h,date_str, ...
        "Particulate Inorganic Carbon",["umol" "L"],Cbounds(1),Cbounds(2),color,marker_color, ...
        xsize,ysize,xmin,xmax,ymin,ymax,zmin,zmax,xunit,yunit,zunit,axisratio,LevelList,transect_Y_position,layertext);
% elseif id == 1001
...
%         tmp = tmp*24*60*60.*mask1;
    ...
    elseif id == 404 % sum of POC
        tmp = ncread(his,'POCTot_01',[1 1 plotZ i],[Inf Inf 1 1]);
        tmp2 = squeeze(ncread(his,'POCTot_01',[1 transectYindex 1 i],[Inf 1 Inf 1]));
    elseif id == 405 % sum of PON
        tmp = ncread(his,'PONTot_01',[1 1 plotZ i],[Inf Inf 1 1]);
        tmp2 = squeeze(ncread(his,'PONTot_01',[1 transectYindex 1 i],[Inf 1 Inf 1]));
    elseif id == 406 % sum of POP
        tmp = ncread(his,'POPTot_01',[1 1 plotZ i],[Inf Inf 1 1]);
        tmp2 = squeeze(ncread(his,'POPTot_01',[1 transectYindex 1 i],[Inf 1 Inf 1]));
    elseif id == 407 % sum of OC
        tmp = ncread(his,'DOCTot_01',[1 1 plotZ i],[Inf Inf 1 1])...
    ...
    elseif id == 410 % sum of phytoplankton
        ...
        tmp = ncread(his,'PhyCTot_01',[1 1 plotZ i],[Inf Inf 1 1]);
        tmp2 = squeeze(ncread(his,'PhyCTot_01',[1 transectYindex 1 i],[Inf 1 Inf 1]));
    elseif id == 411 % sum of zooplankton
        tmp = ncread(his,'ZooCTot_01',[1 1 plotZ i],[Inf Inf 1 1]);
        tmp2 = squeeze(ncread(his,'ZooCTot_01',[1 transectYindex 1 i],[Inf 1 Inf 1]));
    elseif id == 412 % sum of PIC
        tmp = ncread(his,'PICTot_01',[1 1 plotZ i],[Inf Inf 1 1]);
        tmp2 = squeeze(ncread(his,'PICTot_01',[1 transectYindex 1 i],[Inf 1 Inf 1]));
    % elseif id == 1001
